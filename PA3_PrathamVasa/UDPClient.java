...
public static void main(String args[])
{
	try
	{
		...
		for(int i=0;i<number_of_iterations;i++)
		{
			...
			System.out.println("The packet has not lost and has correctly reached the receiver");
			...
			{
			System.out.println("The Packet might have been lost");
			System.out.println("No Acknowledgement from the server side");
